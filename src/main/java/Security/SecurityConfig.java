...
;
    ...
    public class SecurityConfig extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity http) throws Exception {
            ...
            http.authorizeRequests().antMatchers(POST, "/brani/**").hasAnyAuthority("ROLE_ADMIN");
            http.authorizeRequests().antMatchers(PUT, "/brani/**").hasAnyAuthority("ROLE_ADMIN");
            http.authorizeRequests().antMatchers(DELETE, "/brani/**").hasAnyAuthority("ROLE_ADMIN");
